...
public class EMailBO {
	...
	public EMailAddressVOO getEMailAddress(String inEMailID) throws EMailValidationException, Exception{
		...
		if (allMessages.length() == 0){
			...
			eMailAddress = eMailDBAccess.getEMailAddress(inEMailID);// populating EMailAddressVOO object which is eMailAddress
			System.out.println("printing eMailAddress from EMailBO for update query " + eMailAddress.toString() );
		}
		else{
